...
gsap.set(".preloader__letter:nth-child(1)", { x: 0, y: 0, top: "50%", left: "40%", transformOrigin: "center center" }); 
gsap.set(".preloader__letter:nth-child(2)", { x: 0, y: 0, top: "50%", left: "55%", transformOrigin: "center center" }); 
gsap.set(".preloader__letter:nth-child(3)", { x: 0, y: 0, top: "55%", left: "55%", transformOrigin: "center center" }); 
gsap.set(".preloader__letter:nth-child(4)", { x: 0, y: 0, top: "55%", left: "40%", transformOrigin: "center center" }); 
...
function preloaderAnimation() {
  ...
  function handleScroll() {
    if (containerContent) {
      ...
      const leftLetter2 = -100 + distancePercentage * 2 <= 0 ? 0 : -87 + distancePercentage * 2;
